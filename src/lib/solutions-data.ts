...
export const SOLUTIONS: SolutionData[] = [
  {
    ...
    projects: [
      { name: "ALKEMIA", url: "https://goalkemia.com", image: "/images/alora-alkemia-preview.png", es: "Diseño y desarrollo de la nueva plataforma digital de ALKEMIA para acompañar su evolución de marca y consolidar su posicionamiento en tecnología, automatización e inteligencia artificial. El proyecto incluyó estrategia digital, UX/UI, copywriting, desarrollo multilenguaje y una experiencia orientada a comunicar capacidades complejas de forma clara, moderna y escalable.", en: "Design and development of ALKEMIA's new digital platform to support its brand evolution and consolidate its positioning in technology, automation and artificial intelligence. The project included digital strategy, UX/UI, copywriting, multilingual development and an experience geared toward communicating complex capabilities clearly, modernly and at scale." },
      { name: "Castro Yeso", url: "https://castro-yeso.com", image: "/images/alora-castro-yeso-preview.png", es: "Sitio 100% personalizado desarrollado con WordPress sin uso de plantillas, para empresa de yesería y construcción en seco.", en: "100% custom WordPress site built without templates, for a drywall and plasterwork company." },
      { name: "Asesoría Dialogar", url: "https://asesoriadialogar.com.ar", image: "/images/alora-asesoria-dialogar-preview.png", es: "Sitio profesional desarrollado con WordPress para consultoría de recursos humanos.", en: "Professional WordPress site for an HR consulting firm." },
      { name: "Fundación Por Nuestros Niños", url: "http://fpnn.org.ar", image: "/images/alora-fpnn-preview.png", es: "Sitio completamente custom, desarrollado a medida con diseño personalizado que refleja la identidad de la fundación, su misión, programas y formas de colaborar.", en: "Fully custom site, built with tailored design that reflects the foundation's identity, mission, programs and ways to collaborate." },
      { name: "Grupo Terra Lauquen", url: "https://grupoterralauquen.com.ar", image: "/images/alora-grupo-terra-lauquen-preview.png", es: "Sitio corporativo para grupo empresarial con múltiples divisiones. Desarrollo web complejo con gestión de contenido y estructura multinivel.", en: "Corporate site for a business group with multiple divisions. Complex web development with content management and a multi-level structure." },
      { name: "Cichic", url: "https://chichicwinerelax.com", image: "/images/alora-cichic-preview.png", es: "Plataforma e-commerce de moda y accesorios. Desarrollo web completo con catálogo de productos, carrito de compras y pasarela de pago.", en: "Fashion and accessories e-commerce platform. Full web development with product catalog, shopping cart and payment gateway." },
      { name: "Tenis De Mesa Trenque", url: "https://tenisdemesatrenque.com.ar", image: "/images/alora-tenis-de-mesa-trenque-preview.png", es: "Sitio institucional para club deportivo con sistema de gestión de torneos, inscripciones online y resultados en tiempo real.", en: "Institutional site for a sports club with tournament management system, online registration and real-time results." },
    ],
    process: {
      es: [
...

  {
    ...
    projects: [
      { name: "Soy LIDIA", url: "https://soylidia.com", image: "/images/alora-soy-lidia-preview.png", es: "Sistema de gestión para profesionales de la salud con WhatsApp integrado. Calendario, pacientes, equipo, sucursales y pagos.", en: "Management system for health professionals with integrated WhatsApp. Calendar, patients, team, branches and payments." },
      { name: "Ranking Tenis de Mesa", url: "https://tenisdemesatrenque.com.ar", image: "/images/alora-tenis-ranking-preview.png", es: "Sistema completo de gestión de ranking para Tenis de Mesa con perfiles de jugadores, estadísticas y clasificaciones.", en: "Complete ranking management system for Table Tennis with player profiles, statistics and classifications." },
      { name: "LIDIA Superadmin", url: "https://soylidia.com/superadmin", image: "/images/alora-lidia-superadmin-preview.png", es: "Panel de administración del sistema LIDIA con gestión multi-sucursal, reportes y control completo de la plataforma.", en: "LIDIA system administration panel with multi-branch management, reports and full platform control." },
      { name: "Club de Escritura", url: "https://club.rulodeviaje.com", image: "/images/alora-talleres-unidos-preview.png", es: "Sistema web con login de usuarios, suscripción y desafíos mensuales de escritura y lectura para comunidades creativas.", en: "Web system with user login, subscriptions and monthly creative writing and reading challenges for communities." },
      { name: "Protorneos", url: "https://protorneos.com", image: "/images/alora-protorneos-preview.png", es: "Sistema de gestión de torneos y rankings deportivos con panel de administración completo.", en: "Tournament and sports ranking management system with full admin panel." },
    ],
    whyUsExtra: {
...

  {
    ...
    projects: [
      { name: "Mimi Kids", url: "https://mimikids.com.ar", image: "/images/case-studies/mimikids/alora-mimikids-hero-v2.png", es: "Tienda artesanal de portachupetes personalizados con flujo de personalización, panel de administración propio y pagos con MercadoPago.", en: "Handmade personalized pacifier clip store with customization flow, custom admin panel and MercadoPago payments." },
      { name: "Nutriac", url: "https://nutriac.com.ar", image: "/images/alora-nutriac-preview.png", es: "Ecommerce 100% custom de productos nutricionales con integración de pagos local.", en: "100% custom nutritional products ecommerce with local payment integration." },
    ],
    whyUsExtra: {
...

  {
    ...
    projects: [
      { name: "Alora Chatbot", url: "https://www.globalalora.com", image: "/images/alora-chatbot-whatsapp.png", es: "Asistente con IA integrado en nuestro propio sitio y WhatsApp, disponible para resolver consultas y guiar a los visitantes en tiempo real.", en: "AI assistant integrated into our own website and WhatsApp, available to answer questions and guide visitors in real time." },
      { name: "LIDIA", url: "https://soylidia.com", image: "/images/alora-soy-lidia-preview.png", es: "Chatbot con IA para centros médicos y profesionales de la salud, integrado a WhatsApp para gestionar turnos, pacientes y consultas de forma automática.", en: "AI chatbot for medical centers and health professionals, integrated with WhatsApp to automatically manage appointments, patients and inquiries." },
    ],
    whyUsExtra: {
...

  {
    ...
    projects: [
      { name: "Alora Chatbot", url: "https://www.globalalora.com", image: "/images/alora-chatbot-whatsapp.png", es: "Asistente con IA integrado en nuestro propio sitio y WhatsApp, disponible para resolver consultas y guiar a los visitantes en tiempo real.", en: "AI assistant integrated into our own website and WhatsApp, available to answer questions and guide visitors in real time." },
      { name: "LIDIA", url: "https://soylidia.com", image: "/images/alora-soy-lidia-preview.png", es: "Agente conversacional con IA para centros médicos y profesionales de la salud, integrado a WhatsApp para resolver consultas de pacientes de forma automática.", en: "Conversational AI agent for medical centers and health professionals, integrated with WhatsApp to automatically resolve patient queries." },
    ],
    whyUsExtra: {
...

  {
    ...
    hero: {
      es: {
        ...
        sub: "Un mismo sistema de IA que acompaña a tu cliente antes, durante y después de la compra — por WhatsApp, por teléfono y por web — resolviendo lo que necesite en el momento, sin cambiar de canal ni repetir su consulta.",
      },
      en: {
        ...
        sub: "One AI system that supports your customer before, during and after the sale — over WhatsApp, phone and web — resolving whatever they need in the moment, without switching channels or repeating themselves.",
      },
    },
    heroNote: { es: "Llamada online de 20 minutos", en: "20-minute online call" },
    appExplainer: {
