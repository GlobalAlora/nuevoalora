      ...
      >
        ...
        <div className="flex items-center gap-2 border-t p-3" style={{ borderColor: "rgba(255,255,255,0.07)" }}>
          <input
            ...
            className="flex-1 rounded-xl px-4 py-2.5 text-[16px] text-white/90 placeholder:text-white/25 outline-none transition-[border-color,box-shadow] duration-150 focus:border-[color-mix(in_oklab,var(--turquoise)_55%,transparent)] focus:shadow-[0_0_0_3px_color-mix(in_oklab,var(--turquoise)_15%,transparent)]"
