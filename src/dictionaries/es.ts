...
const es: Dictionary = {
  ...
  cases: {
    ...
    items: [
      ...
      { slug: "tony-piorno", client: "Tony Piorno", desc: "Media kit digital para creador de contenido, con métricas en vivo, audiencia segmentada y formulario de propuestas para marcas.", tags: ["Web"] },
  ...
  reviewForm: {
    ...
    cargoPlaceholder: "Ej: Gerente de Marketing",
    company: "Nombre de la empresa",
    companyPlaceholder: "Opcional",
    rating: "Calificá tu experiencia con nosotros",
    review: "Contanos tu experiencia",
    reviewPlaceholder: "Nos encantaría saber cómo te sentiste con el equipo, qué es lo que más te gustó de trabajar con nosotros, describí el proyecto que hicimos juntos, si nos recomendarías, y todo lo que quieras contarle al mundo sobre cómo trabajamos en ALORA.",
    privacyText: "Acepto que ALORA pueda publicar esta reseña completa o un extracto en su sitio web.",
