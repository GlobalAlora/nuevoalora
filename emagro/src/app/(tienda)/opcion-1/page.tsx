...
export const metadata = { title: "Emagro — Opción 1" };

export default function Opcion1Page() {
  return (
      ...
      <section className="bg-surface py-16">
        <div className="mx-auto max-w-7xl px-4">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link href="/opcion-1/categoria" className="text-primary text-sm font-semibold">
              Ver todas →
            </Link>
          </div>
